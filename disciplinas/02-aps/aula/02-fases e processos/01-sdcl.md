...
## Conteúdo:
  - Ciclo de Desenvolvimento
    - planejamento/estruturação → execução/desenvolvimento → finalização/implementação;
    - Validação e Verificação.
  - Modelos de Desenvolvimento de Software
  - Manifesto Ágil
    - 4 valores (pessoas, software funcionando, interação cliente, responder as mudanças)
    - XP, scrum, Kanban
...
## Conteúdo Prótxima aula
- Levantamento de requisitos: conceitos, termos, técnicas, comunicação/linguagem. 
- Análise de requisitos: objetivo, padrões, modelagens, priorização e validação.
