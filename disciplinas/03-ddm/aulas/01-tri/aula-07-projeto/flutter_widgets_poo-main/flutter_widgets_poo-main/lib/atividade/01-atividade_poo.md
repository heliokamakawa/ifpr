# Atividade - Criacao de Objetos

## Objetivo

O objetivo desta atividade e treinar a criacao de objetos no formato de instancia anonima.

Mais do que apenas "fazer funcionar", a proposta e fortalecer os pontos fundamentais da leitura e da escrita de codigo em Dart:

- entender o que e parametro;
- diferenciar parametro nomeado de parametro posicional;
- perceber quando usar `,` e quando usar `.`;
- identar corretamente objetos aninhados;
- ganhar fluencia para criar objetos dentro de objetos;
- fortalecer a leitura tecnica desse formato.

Didaticamente, a ideia e simples:

se o aluno consegue ler e montar bem o formato mais dificil, o restante tende a ficar mais facil.

Esta atividade tambem ajuda a consolidar a base que depois aparece no Flutter:

- widgets criados como instancias anonimas;
- objetos aninhados;
- parametros nomeados;
- leitura de construtores com mais seguranca.

## Orientacao de estudo

O material foi organizado com:

- 5 exercicios resolvidos;
- 23 exercicios para pratica.

Quem tem dificuldade precisa treinar.

Quem nao tem dificuldade deve fazer o equivalente necessario para demonstrar dominio real do formato.

O foco nao e apenas "terminar a lista", mas desenvolver seguranca para:

- ler;
- montar;
- identar;
- corrigir;
- explicar a criacao de objetos nesse modelo.
