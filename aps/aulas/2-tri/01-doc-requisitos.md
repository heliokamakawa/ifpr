...
| REQ-005 | **Manutenir Ocorrências de Achados e Perdidos** — campos: <br>  - `*Descrição`: campo texto. <br>  - `*Data do Registro`: máscara `dd/mm/aaaa`. <br>  - `&Status`: opções — Encontrado, Entregue, Descartado.                                                                                                                                                            | Média      | LRE-002-001 | - Permitir registrar novas ocorrências. <br> - Permitir alteração de status. <br> - Validar obrigatoriedade dos campos. <br> - Impedir exclusão de registros com status "Entregue" ou "Descartado".                                                                                                        |
